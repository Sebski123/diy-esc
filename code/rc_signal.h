...
//Converts pulse time measurement to PWM value
	...
	#define TIMER0_TCCR0		(1 << CS01) //clk/8
	...
	#define SIGNAL_TICKS_OFFTHR	(SIGNAL_TICKS_LOW + (((SIGNAL_TICKS_HIGH - SIGNAL_TICKS_LOW) / PWM_RANGE) * PWM_MIN)) //While motor is running, PWM wont turn off until signal is below this value
#endif
